...
- уровни пирамиды: `верхние → жоғарғы`, `сердечные/средние → жүрек`, `базовые/нижние → негізгі`; плоский список нот нельзя самостоятельно превращать в пирамиду;
- повторно подтверждённые review-правила включают `свежесть → балғындық`, perfume `пряный/пикантный → татымды`, perfume `кожа → былғары`, `имбирь → зімбір`, `мята → жалбыз`; кедр не подменяется другим хвойным деревом.
