...
// @updateURL    https://raw.githubusercontent.com/mbtema/strapi/main/strapi-ui-scripts/entry-relocate.js
// @downloadURL  https://raw.githubusercontent.com/mbtema/strapi/main/strapi-ui-scripts/entry-relocate.js
...
(function () {
    ...
    function apply() {
        ...
        console.log(
            '[ENTRY] v1.4.1: UI применён без искусственной задержки'
        );
    }
